package pl.java.scalatech.behave.aware;
...
import pl.java.scalatech.scopeBehave.config.aware.SingletonBehaveAwareConfig;
import pl.java.scalatech.scopeBehave.config.singleton.StoreService;

@Slf4j
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(classes=SingletonBehaveAwareConfig.class)
public class BehaveAwareScopeTest {
